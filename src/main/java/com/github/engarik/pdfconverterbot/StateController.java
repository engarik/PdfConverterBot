...
import com.github.engarik.pdfconverterbot.handlers.impl.TelegramDownloadHandler;
import com.github.engarik.pdfconverterbot.image.ImageHandler;
import com.github.engarik.pdfconverterbot.image.impl.ImageTransformer;
...
public class StateController {
    ...
    public void closePdf(String chatId) throws TelegramApiException {
        ...
        try {
            pdfHandler.handle("userFiles/" + chatId);
        } catch (Exception e) {
            e.printStackTrace();
        }
